...
export default function MagicRings({
  ...
  // Respect prefers-reduced-motion: tone down speed/glow/opacity.
  const reduced =
  ...
  propsRef.current = {
    ...
    ringCount,
    attenuation: reduced ? attenuation * 1.4 : attenuation,
    lineThickness,
    baseRadius,
    radiusStep,
    scaleRate: reduced ? scaleRate * 0.4 : scaleRate,
    opacity: reduced ? opacity * 0.75 : opacity,
    noiseAmount: reduced ? noiseAmount * 0.4 : noiseAmount,
    rotation,
    ringGap,
    fadeIn,
    fadeOut,
    followMouse,
    mouseInfluence,
    hoverScale: reduced ? 1 : hoverScale,
    parallax: reduced ? parallax * 0.3 : parallax,
    clickBurst: reduced ? false : clickBurst,
  };
